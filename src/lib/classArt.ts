/** Classes with painted banner art at public/class-art/{id}.webp (2508×627
    source masters live in assets/Class Cards/). Classes outside this set fall
    back to the engraved class icon. */
