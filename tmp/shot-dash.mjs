...
await p.locator('button[title="Campaigns"]').first().click({ timeout: 10000 });
await p.waitForTimeout(2000);
await p.screenshot({ path: "QA/screenshots/ao-baseline/P5-dashboard-1440x900.png" });
await p.setViewportSize({ width: 390, height: 844 });
await p.waitForTimeout(700);
await p.screenshot({ path: "QA/screenshots/ao-baseline/P5-dashboard-390x844.png" });
await b.close();
console.log("done");
